...
/**
 *
 * @author Adit Shah, Avinash, and Ashu
 */
 ...
 * @author aditshah
 */
public class MassHousingPhase2 {
    ...
    private double[] validate(Instances data) throws Exception{
        ...
        Remove remove =new Remove();
        //remove.setAttributeIndices("2-6,9-10,15,18,20-52");//1 7 8 9 10 19  33
        remove.setAttributeIndices("2,10");
        ...
        double num_key1[] = data.attributeToDoubleArray(9);
    ...
    public static void main(String args[]) throws Exception{
        ...
        MassHousingPhase2 m = new MassHousingPhase2();
        ...
        if(args.length > 0){
            ...
            data_test = m.copyAtt(data_test);
            data_test = m.dataToNominal(data_test);
            data_test = m.string2nominal(data_test);
            data_test = m.removeAtt(data_test);
            data_test = m.sortLabels(data_test);
            Remove remove =new Remove();
            //remove.setAttributeIndices("2-6,9-10,15,18,20-52");//1 7 8 9 10 19  33
            remove.setAttributeIndices("2,10");
            remove.setInputFormat(data);
            ...
            remove.setInputFormat(data_test);
            data_test = Filter.useFilter(data_test, remove);
            data.setClassIndex(data.numAttributes() - 1);
